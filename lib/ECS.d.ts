...
export default class ECS {
     ...
     * @param debug boolean.
     */
    constructor(log: LogCallbacks, debug?: boolean);
    /**
     ...
     * @param component Component instance.
     */
    removeComponent(entity: Entity, component: Function): void;
    /**
    ...
    setComponent<T extends Component>(entity: Entity, componentClass: ComponentClass<T>, values: Partial<T>): void;
    /**
    ...
    getComponentIfExist<T extends Component>(entity: Entity, componentClass: ComponentClass<T>): T | null;
    /**
     ...
     */
    hasComponent(entity: Entity, component: Function): boolean;
    /**
     ...
     * @returns
     */
    hasAnyComponents(entity: Entity, components: Iterable<Function>): boolean;
    /**
     ...
     * @returns
     */
    hasAllComponents(entity: Entity, components: Iterable<Function>): boolean;
    /**
